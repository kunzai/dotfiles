...
-- automatically reload Spoons
hs.loadSpoon("ReloadConfiguration")
spoon.ReloadConfiguration:start()

-- automatically reload config after changes
...
for mnemonic, callback_info in pairs(key_bindings_application) do
   hs.hotkey.bind(application_keys, mnemonic, function()
      callback_info = key_bindings_application[mnemonic]
...
-- for mnemonic, callback_info in pairs(key_bindings_hyper) do
   -- hs.hotkey.bind(hyper_keys, mnemonic, function()
      -- callback_info = key_bindings_hyper[mnemonic]
...
for mnemonic, callback_info in pairs(key_bindings_move) do
   hs.hotkey.bind(move_keys, mnemonic, function()
      callback_info = key_bindings_move[mnemonic]
...
--
-- I mean screen.
hs.hotkey.bind(move_keys, "H", function()
    local win = hs.window.focusedWindow()
    local win_frame = win:frame()
...
hs.hotkey.bind(move_keys, "J", function()
    local win = hs.window.focusedWindow()
    local win_frame = win:frame()
...
hs.hotkey.bind(move_keys, "K", function()
    local win = hs.window.focusedWindow()
    local win_frame = win:frame()
...
hs.hotkey.bind(move_keys, "L", function()
    local win = hs.window.focusedWindow()
    local win_frame = win:frame()
